...
let serverCertO = fs.readFileSync(path.join(__dirname, '/crypto-config/ordererOrganizations/switch2logic.co.za/orderers/orderer0.hospital1.switch2logic.co.za/msp/tlscacerts/tlsca.switch2logic.co.za-cert.pem'));
...
var channel = fabric_client.newChannel('comunitychannel');
var peer = fabric_client.newPeer('grpcs://peer0.hospital1.switch2logic.co.za:7051',
{
...
var order = fabric_client.newOrderer('grpcs://orderer0.hospital1.switch2logic.co.za:7050',{
	'pem': Buffer.from(serverCertO).toString()
});
